...
(function (t, i, n, e) {
    "use strict";
    var r, o, s, a, h, l, c, u, p, d, f, m, w, y, g, b, v, x, S, P, C, N, k, H, T, A, M,
    ...
    C = "notify", P = C + "js", s = C + "!blank", k = {
    ...
    }, T = {"border-radius": ["-webkit-", "-moz-"]}, f = function (t) {
        return A[t]
    }, o = function (i, e) {
        var r, o, s, a;
        ...
        function t(t, i, e) {
            "string" == typeof e && (e = {className: e}), this.options = g(N, n.isPlainObject(e) ? e : {}), this.loadHTML(), this.wrapper = n(a.html), this.options.clickToHide && this.wrapper.addClass("" + P + "-hidable"), this.wrapper.data(P, this), this.arrow = this.wrapper.find("." + P + "-arrow"), this.container = this.wrapper.find("." + P + "-container"), this.container.append(this.userContainer), t && t.length && (this.elementType = t.attr("type"), this.originalElement = t, this.elem = d(t), this.elem.data(P, this), this.elem.before(this.wrapper)), this.container.hide(), this.run(i)
        }
    ...
    }, n.extend(n[C], {defaults: l, addStyle: o, pluginOptions: N, getStyle: f, insertCSS: b}), n(function () {
